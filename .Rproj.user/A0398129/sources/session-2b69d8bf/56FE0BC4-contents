...
# Acquiring Austin-Round Rock-Georgetown Metropolitan Statistical Area
# Tract level data in Texas, USA

# Using suggest_crs() to find appropriate projection for Austin MSA
...
# How many people live in this MSA? 
# Answer: 2,283,371 people.
sum(tx_tracts$value)

# Population density, people per square kilometer
# ALAND / 1e6 because ALAND default values are in square meters
tx_tracts_dens <- tx_tracts %>%
  mutate(pop_dens = (tx_tracts$value) / (tx_tracts$ALAND / 1e6))
